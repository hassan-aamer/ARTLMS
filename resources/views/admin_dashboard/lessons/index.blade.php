...
@section('Page_Title')  الدروس والمحاضرات @endsection
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center">
                <h5 class="mb-0"> <i class="lni lni-book"></i> الدروس والمحاضرات </h5>
                <div class="ms-auto position-relative">
                    <a href="{{route('lessons.create')}}" class="btnIcon btn btn-outline-primary px-5"><i class="lni lni-circle-plus"></i> أضف عنصر جديد </a>
                </div>
            </div>
                ...
                <table class="table align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$con->unit?->title ? $con->unit?->title : 'العنصر منفصل'}}</td>
                            <td>{{$con->title}}</td>
                            ...
                            <td>
                                <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                    <a href="{{route('lessons.edit', $con->id)}}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{route('lessons.destroy',$con->id)}}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
