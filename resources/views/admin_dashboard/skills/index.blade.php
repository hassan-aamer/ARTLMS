...
@section('Page_Title')   المهارات المتوقعة @endsection
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center">
                <h5 class="mb-0"> <i class="bx bx-trophy"></i> المهارات المتوقعة </h5>
                <div class="ms-auto position-relative">
                    <a href="{{route('skills.create')}}" class="btnIcon btn btn-outline-primary px-5"><i class="lni lni-circle-plus"></i> أضف عنصر جديد </a>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                    <a href="{{route('skills.edit', $con->id)}}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{route('skills.destroy',$con->id)}}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
