...
@section('Page_Title')    المعلمين | تعديل   @endsection
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <h5 class="mb-0"> <i class="bi bi-grid-fill"></i>   المعلمين | تعديل ({{$content->email}}) </h5>
                    </div>
                            ...
                            <div class="card shadow-none bg-light border">
                                <div class="card-body">
                                    <form class="row g-3" id="validateForm" method="post" enctype="multipart/form-data"
                                          action="{{route('teachers.update', $content->id)}}">
                                        @method('put')
                                        @csrf
