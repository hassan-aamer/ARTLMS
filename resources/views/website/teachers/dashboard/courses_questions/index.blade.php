    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center">
                <h5 class="mb-0"> <i class="bi bi-grid-fill"></i>  أسألة المتعلمين </h5>
            </div>
                ...
                <table class="table align-middle">
                    ...
                    @forelse($content as $con)
                        <tr>
                            ...
                            <td><span class="badge @if($con->answer == null) bg-light-danger text-danger @else bg-light-success text-success @endif w-50">
                                    {{ $con->answer == null ? 'لم يتم الرد' : 'تم الاجابة' }}</span></td>
                            <td>
                                <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                    <a href="{{route('courses_questions.edit', $con->id)}}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{route('courses_questions.destroy',$con->id)}}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
