...
@section('page_title')  تسجيل الدخول  للمتعلمين  @endsection
@section('content')
                ...
                <div class="col-md-6 col-xl-5">
                    ...
                    <div class="login-form">
                        <div class="form-header">
                            <h2 class="font-weight-bold mb-2 fs-4">تسجيل الدخول للمتعلمين</h2>
                            <p class="woocommerce-register" style="line-height: 20px">
                                ادخل بيانات الحساب وقم بتسجيل الدخول
                            </p>
                        </div>
                        <form method="post" action="{{route('website.student.login')}}" class="woocommerce-form woocommerce-form-login login">
                            @csrf
